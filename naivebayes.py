...
def naive_bayes_classify(vec_to_classify, prob_vector_c1, prob_vector_c0, prior_c1):
    ...
    log_posterior_c0 = sum(log_prob_vector_c0 * vec_to_classify) + log(
        1.0 - prior_c1)  # log(p(c_0|w)) = log(p(w|c_0)p(c_0))
...
def test_naive_bayes():
    ...
    print test_vector_1, 'classified as : ', naive_bayes_classify(test_feat_vec_1, prob_vector_c1, prob_vector_c0,
                                                                  prior_c1)
    test_vector_2 = ['stupid', 'garbage']  # test 2
    test_feat_vec_2 = dataset_to_feat_vector(voca_dictionary, test_vector_2)
    print test_vector_2, 'classified as : ', naive_bayes_classify(test_feat_vec_2, prob_vector_c1, prob_vector_c0,
                                                                  prior_c1)
